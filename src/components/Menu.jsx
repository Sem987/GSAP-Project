...
export const Menu = () => {
    ...
    useGSAP(() => {
        ...
        gsap.fromTo('.details h2', {opacity: 0, yPercent: 100}, {opacity: 1, duration: 1, yPercent: 0, ease: 'power1.out' });
        gsap.fromTo('.details p', {opacity: 0, yPercent: 100}, {opacity: 1, duration: 1, yPercent: 0, ease: 'power1.out' });
    }, [currentIndex]);
